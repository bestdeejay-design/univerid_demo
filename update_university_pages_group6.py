#!/usr/bin/env python3
"""
Script to update the final university page with standard header and footer
"""
...
def main():
    # The final university file to update
    university_files = [
        "технологический-колледж-21-university.html"
    ]

#!/usr/bin/env python3
"""
Script to update university pages with standard header and footer
"""
...
def main():
    # List of the first 15 university files to update
    university_files = [
        "spbgu-university.html",
        "technologika-university.html", 
        "военмех-им-д-ф-устинова-university.html",
        "европейский-университет-в-санкт-петербурге-university.html",
        "кип-колледж-информатики-и-программирования-university.html",
        "колледж-авиационного-и-промышленного-машиностроения-university.html",
        "колледж-автоматизации-и-информационных-технологий-20-university.html",
        "колледж-архитектуры-строительства-и-геоинформационных-технологий-university.html",
        "колледж-водных-ресурсов-и-экологии-university.html",
        "колледж-дизайна-и-декоративно-прикладного-искусства-им-н-к-рериха-university.html",
        "колледж-железнодорожного-транспорта-3-university.html",
        "колледж-индустрии-питания-и-сферы-услуг-university.html",
        "колледж-инженерных-технологий-и-робототехники-university.html",
        "колледж-кино-и-телевидения-university.html",
        "колледж-ландшафтного-дизайна-и-садово-паркового-строительства-university.html"
    ]

#!/usr/bin/env python3
"""
Script to update university pages with standard header and footer - Group 2
"""
...
def main():
    # List of the second 15 university files to update
    university_files = [
        "колледж-международного-бизнеса-и-права-university.html",
        "колледж-международного-туризма-и-гостеприимства-university.html",
        "колледж-музыкально-театрального-искусства-university.html",
        "колледж-психологии-и-социальной-работы-university.html",
        "колледж-санкт-петербург-university.html",
        "колледж-современной-медицины-и-реабилитации-university.html",
        "колледж-судостроения-и-прикладных-технологий-university.html",
        "колледж-телекоммуникаций-7-university.html",
        "колледж-управления-и-сервиса-32-university.html",
        "колледж-фармацевтики-и-биомедицины-university.html",
        "колледж-цифровой-экономики-и-предпринимательства-university.html",
        "колледж-цифровых-технологий-и-информационной-безопасности-university.html",
        "колледж-экономики-управления-и-права-university.html",
        "колледж-энергетики-и-автоматики-university.html",
        "коллеж-современных-технологий-18-university.html"
    ]
